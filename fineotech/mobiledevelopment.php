...
<section id="mobile-solution" class="mobile-solution pt-5 pb-5">
    <div class="container">
        ...
        <div class="container">
            <div class="row align-items-center custome-mobile-technolgy-row">
                <div class="col-xs-12 flex-nowrap mobile-solution-img">
                    ...
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_objective_c.png" alt="">
                        <p>Objective-C</p>
                    </div>
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_kotlin.png" alt="">
                        <p>Kotlin</p>
                    </div>
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_java.png" alt="">
                        <p>Java</p>
                    </div>
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_flutter.png" alt="">
                        <p>Flutter</p>
                    </div>
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_xamarin.png" alt="">
                        <p>Xamarin</p>
                    </div>
                    <div class="text-center">
                        <img class="img-fluid" src="img/features/mobile2_android.png" alt="">
                        <p>Android</p>
                    </div>
                </div>
            </div>
...
<section id="mobile-solution-2" class="mobile-solution pt-5 pb-5">
    <div class="container">
        ...
        <div class="row pb-5">
            ...
            <div class="col-md-4 mobile-solution-section">
                <div class="col-md-4 float-left">
                    <img class="img-fluid" src="img/features/mobile3_payroll.png" alt="">
                </div>
                <div class="col-md-8 float-right">
        ...
        <div class="row pb-5">
            <div class="col-md-4 mobile-solution-section">
                <div class="col-md-4 float-left">
                    <img class="img-fluid" src="img/features/mobile3_loyalty.png" alt="">
                </div>
                <div class="col-md-8 float-right">
            ...
            <div class="col-md-4 mobile-solution-section">
                <div class="col-md-4 float-left">
                    <img class="img-fluid" src="img/features/mobile3_pos.png" alt="">
                </div>
                <div class="col-md-8 float-right">
...
<section id="mobile-strategy" class="mobile-strategy pt-4">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <img class="img-fluid" src="img/features/mobile.jpg" alt="">
            </div>
        </div>
    </div>
</section>
...
<section id="mobile-services" class="mobile-services pt-5 pb-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12">
...
<section id="mobile-blog" class="mobile-blog pt-5 pb-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-12">
                <div class="mobile-blog-header">
                    <p class="mobile-blog-title"><span>Our Blog
                        </span></p>
                    <p class="mobile-blog-text text-center">Get the latest news and insights as innovative payments apps
                        are fast
                        becoming the driving force
                        behind security, speed, reliability and efficiency for businesses as well as customers.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-5">
            <div class="col-md-6">
                <div class="card mobile-blog-card">
            ...
            <div class="col-md-6">
                <div class="card mobile-blog-card-2">
                    <div class="blog-part-2-img">
                        <img class="card-img-top mobile-blog-image-2" src="img/hero-area.jpg" alt="Card image">
                    </div>
